...
redshift = 0.0
Lbox = 250
particle_mass = 8*1.44e8

hlist = np.loadtxt('/home/yymao/chinchilla/c250-1024/hlist_1.00000.list')
...
h_vacc = hlist[:,58]
h_vpeak = hlist[:,59]
h_halfmass_scale_factor = hlist[:,60]
h_dmvir_dt_inst = hlist[:,61]
h_dmvir_dt_100myr = hlist[:,62]
h_dmvir_dt_tdyn = hlist[:,63]
...
halo_catalog = USHC(redshift = redshift, Lbox = Lbox, particle_mass = particle_mass, number_of_particles = 1024**3,\
...
halo_catalog.add_halocat_to_cache('/home/kuw8/.astropy/cache/halotools/halo_catalogs/chinchilla/rockstar/hlist_1.00000.list.250-1024.hdf5', 'chinchilla', 'rockstar', '250-1024', '#')
print 'cached'
