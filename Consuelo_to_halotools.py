...
hlist4040 = np.loadtxt('/home/yymao/consuelo/4040/hlist_1.00000.list')
...
h_vacc = hlist[:,36]
h_vpeak = hlist[:,37]
h_halfmass_scale_factor = hlist[:,38]
h_dmvir_dt_inst = hlist[:,39]
h_dmvir_dt_100myr = hlist[:,40]
h_dmvir_dt_tdyn = hlist[:,41]
...
halo_catalog.add_halocat_to_cache('/home/kuw8/.astropy/cache/halotools/halo_catalogs/consuelo20/rockstar/hlist_1.00000.list.0_4040.hdf5', 'consuelo20', 'rockstar', '0_4040', '#')
print 'cached'
