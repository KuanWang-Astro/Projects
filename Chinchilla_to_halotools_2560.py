...
redshift = 0.0
Lbox = 250
particle_mass = (2048./2560.)**3*1.44e8

hlist = np.loadtxt('/home/yymao/chinchilla/c250-2560/hlist_1.00000.list')
...
h_vacc = hlist[:,62]
h_vpeak = hlist[:,63]
h_halfmass_scale_factor = hlist[:,64]
h_dmvir_dt_inst = hlist[:,65]
h_dmvir_dt_100myr = hlist[:,66]
h_dmvir_dt_tdyn = hlist[:,67]
...
halo_catalog = USHC(redshift = redshift, Lbox = Lbox, particle_mass = particle_mass, number_of_particles = 2560**3,\
...
halo_catalog.add_halocat_to_cache('/home/kuw8/.astropy/cache/halotools/halo_catalogs/chinchilla/rockstar/hlist_1.00000.list.250-2560.hdf5', 'chinchilla', 'rockstar', '250-2560', '#')
print 'cached'
