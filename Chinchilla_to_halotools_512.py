...
redshift = 0.0
Lbox = 250
particle_mass = 64*1.44e8

hlist = np.loadtxt('/home/yymao/chinchilla/c250-512/hlist_1.00000.list')
...
halo_catalog = USHC(redshift = redshift, Lbox = Lbox, particle_mass = particle_mass, number_of_particles = 512**3,\
...
halo_catalog.add_halocat_to_cache('/home/kuw8/.astropy/cache/halotools/halo_catalogs/chinchilla/rockstar/hlist_1.00000.list.250-512.hdf5', 'chinchilla', 'rockstar', '250-512', '#')
print 'cached'
